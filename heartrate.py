    ...
    while alive:
        ...
        if pulse_position >= 0:
            if pulse_position >= len(pulse_part):
                pulse_position = -1
                next_height = size[1] //2
            else:
                next_height = (size[1] //2 ) - (pulse_part[pulse_position] * vert_scale_factor)
                pulse_position +=1
        else:
        ...
        pygame.draw.line(drawing,(255,14,14,255),(ptr,last_height),(next_ptr,next_height),4)
